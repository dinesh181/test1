		...
		<div class="form-v10-content">
			<form class="form-detail" action="AdminRegistration" method="post" id="myform">
				...
				<div class="form-right">
					...
					<div class="form-group">
						<div class="form-row form-row-1">
							<a href="ShowMenuItemListAdmin" class="b">Users Approval</a>
						</div>
					</div>
					<div class="form-row">
						<a  href="RegistrationRequest" class="b">Processed Claims</a>
					</div>
					<div class="form-row">
						<a  href="RegistrationRequest" class="b">Plan Codes</a>
					</div>
				
					<div class="form-row">
						<a  href="RegistrationRequest" class="b">Claim to be Processed</a>
					</div>
					<div class="form-row">
						<a  href="RegistrationRequest" class="b">Processed Claims</a>
					</div>
